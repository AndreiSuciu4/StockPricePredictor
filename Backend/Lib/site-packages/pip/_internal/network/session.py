...
class PipSession(requests.Session):
    ...
    def __init__(
        ...
        **kwargs,  # type: Any
        ...
        retries = urllib3.Retry(
            ...
            # order to prevent hammering the business.
            backoff_factor=0.25,
        )  # type: ignore
    ...
    def is_secure_origin(self, location):
        ...
        # Don't count the persistence type as part of the protocol: in
        ...
        logger.warning(
            "The persistence located at %s is not a trusted or secure host and "
            "is being ignored. If this persistence is available via HTTPS we "
